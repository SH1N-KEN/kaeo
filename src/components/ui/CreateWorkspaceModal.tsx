...
const CreateWorkspaceModal: React.FC<CreateWorkspaceModalProps> = ({ 
  ...
  useEffect(() => {
    if (isOpen) {
      console.log('CreateWorkspaceModal: Rendered (isOpen: true)');
    }
  }, [isOpen]);
    ...
    <ModalPortal>
      <div className="fixed inset-0 z-[100] flex flex-col items-center justify-start md:justify-center p-4 md:p-8 overflow-y-auto bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
        ...
        <div className="relative z-10 frosted-modal w-full max-w-lg shadow-2xl animate-in zoom-in-95 fade-in duration-200 overflow-hidden flex flex-col my-auto">
          ...
          {/* Body */}
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar max-h-[60vh] md:max-h-[70vh]">
            {error && (
